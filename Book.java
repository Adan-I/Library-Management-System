...
public class Book {
	...
	public boolean equals(Object other) {
		...
		return 	this.isbn == otherBook.isbn && this.authorOtherName.equals(((Book) other).authorOtherName) && this.authorSurname.equals(otherBook.authorSurname) && this.title.equals(otherBook.title);
	}
}